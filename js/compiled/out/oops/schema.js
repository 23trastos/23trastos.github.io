...
var G__14604 = cljs.core.first.call(null,element_str);
switch (G__14604) {
case "?":
arr.push((1));
...
var G__14606 = cljs.core.next.call(null,items);
items = G__14606;
continue;
} else {
return null;
...
var G__14607 = cljs.core.next.call(null,items);
items = G__14607;
continue;
} else {
return null;
...
var G__14609 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__14609;
continue;
} else {
return true;
...
switch (G__14612) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__14612){
return (function (p1__14610_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14610_SHARP_,(2));
});})(G__14612))
))){
...
return cljs.core.not_EQ_.call(null,p1__14611_SHARP_,(1));
});})(G__14612))
))){
