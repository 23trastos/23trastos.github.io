...
if((i < len)){
var k = (ks[i]);
var G__19816 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__19817 = (i + (1));
m = G__19816;
i = G__19817;
continue;
...
return G__19819__$1.reagentRender;
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__19821 = c;
var G__19821__$1 = (((G__19821 == null))?null:G__19821.prototype);
if((G__19821__$1 == null)){
return null;
} else {
return G__19821__$1.render;
}
})() == null))));
});
...
var G__19828 = c;
var G__19828__$1 = (((G__19828 == null))?null:G__19828.constructor);
if((G__19828__$1 == null)){
return null;
} else {
return G__19828__$1.displayName;
}
});
...
var _STAR_current_component_STAR_19829 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_19829;
}});
...
return ((function (G__19830,G__19830__$1){
...
var c = this;
var G__19835_19837 = goog.object.get(c,"cljsRatom");
if((G__19835_19837 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__19835_19837);
}
...
var renders_19838 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_19839 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_19838));
...
if((cljs.core.count.call(null,renders_19838) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_19838))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_19839)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_19839))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__19840 = o;
goog.object.set(G__19840,cljs.core.name.call(null,k),v);
