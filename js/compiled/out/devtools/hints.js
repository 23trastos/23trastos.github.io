...
var line = cljs.core.get.call(null,map__24400__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
}catch (e24399){var _e = e24399;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24402 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24402)){
var seen_errors_24403 = temp__5455__auto___24402;
if(cljs.core.truth_(seen_errors_24403.has(self))){
} else {
seen_errors_24403.add(self);

var temp__5457__auto___24404 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24404)){
var sense_24405 = temp__5457__auto___24404;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24405)].join('');
} else {
}
}
} else {
