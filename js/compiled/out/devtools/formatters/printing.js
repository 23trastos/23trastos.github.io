...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23381){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23382,G__23383,seq23381__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23387_SHARP_){
return !((cljs.core.meta.call(null,p1__23387_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23388__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23392){var _e__22372__auto__ = e23392;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e23394){var _e__22372__auto__ = e23394;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23396 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23397 = opts;
...
var markup_db = cljs.core.get.call(null,map__23397__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23396;
}});
...
;
var temp__5455__auto___23401 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23401)){
var managed_print_level_23402 = temp__5455__auto___23401;
var _STAR_print_level_STAR_23400_23403 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23402;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23400_23403,managed_print_level_23402,temp__5455__auto___23401,writer,opts,job_fn){
return (function (p1__23399_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23399_SHARP_,null);
});})(_STAR_print_level_STAR_23400_23403,managed_print_level_23402,temp__5455__auto___23401,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23400_23403;
}} else {
job_fn.call(null);
}
