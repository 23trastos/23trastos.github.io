...
var o23046 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23046["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23047 = temp__5455__auto____$1;
return (o23047["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22158__auto__ = f;
return (o__22158__auto__["toString"]).call(o__22158__auto__);
} else {
return "";
}
}catch (e23048){var _ = e23048;
return "";
}});
...
try{var o__22158__auto___23050 = t;
(o__22158__auto___23050["cljs$lang$ctorPrWriter"]).call(o__22158__auto___23050,t,writer);
}catch (e23049){var __23051 = e23049;
}
...
var char_code = (function (){var o__22158__auto__ = (new String(char$));
return (o__22158__auto__["charCodeAt"]).call(o__22158__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22158__auto__ = String;
return (o__22158__auto__["fromCharCode"]).call(o__22158__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23052 = num_code;
switch (G__23052) {
case (1):
return (185);
...
var o__22158__auto__ = String;
return (o__22158__auto__["fromCharCode"]).call(o__22158__auto__,superscript_code);
});
/**
...
}catch (e23054){var _e__22165__auto__ = e23054;
return false;
}})())){
...
var vec__23055 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23055,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23058 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23058["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23059 = temp__5455__auto____$1;
return (o23059["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23062){
var vec__23063 = p__23062;
var ns_detector = cljs.core.nth.call(null,vec__23063,(0),null);
...
var G__23069 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23070 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23069;
remaining_tokens = G__23070;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23060){
var G__23061 = cljs.core.first.call(null,seq23060);
var seq23060__$1 = cljs.core.next.call(null,seq23060);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23061,seq23060__$1);
});
...
var vec__23074 = cljs.core.split_with.call(null,(function (p1__23073_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23073_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23074,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23074,(1),null);
...
var vec__23077 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23077,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23077,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23080 = cljs.core.rest.call(null,remaining_tokens);
var G__23081 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23080;
name_tokens = G__23081;
continue;
} else {
...
var vec__23084 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23084,(0),null);
var arity = cljs.core.nth.call(null,vec__23084,(1),null);
var vec__23087 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23087,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23087,(1),null);
var vec__23090 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23090,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23090,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23090,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23090,(3),null);
...
var vec__23096 = result;
var munged_ns = cljs.core.nth.call(null,vec__23096,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23096,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23096,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23096,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23096,(4),null);
var arity = cljs.core.nth.call(null,vec__23096,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23100 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23100,(0),null);
var args = cljs.core.nth.call(null,vec__23100,(1),null);
var vec__23103 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23103,(0),null);
var name = cljs.core.nth.call(null,vec__23103,(1),null);
...
var G__23106 = (arity + (1));
var G__23107 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23108){
var vec__23109 = p__23108;
var arity = cljs.core.nth.call(null,vec__23109,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23109,(1),null);
...
return cljs.core.get.call(null,arities,p1__23112_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23113_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23116){
var vec__23117 = p__23116;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23117,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23114){
var G__23115 = cljs.core.first.call(null,seq23114);
var seq23114__$1 = cljs.core.next.call(null,seq23114);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23115,seq23114__$1);
});
...
var map__23125 = options;
var map__23125__$1 = ((((!((map__23125 == null)))?(((((map__23125.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23125.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23125):map__23125);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23125__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23125__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23125__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23125__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23126 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23126,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23126,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23126,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23126,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23126,(4),null);
var arity = cljs.core.nth.call(null,vec__23126,(5),null);
...
var o__22158__auto__ = f;
return (o__22158__auto__["getBasis"]).call(o__22158__auto__);
});
/**
...
}catch (e23130){var _e__22165__auto__ = e23130;
...
var G__23131 = (obj[cljs.core.first.call(null,path)]);
var G__23132 = cljs.core.rest.call(null,path);
obj = G__23131;
path = G__23132;
continue;
} else {
...
return (function (accum,p__23133){
var vec__23134 = p__23133;
var bit = cljs.core.nth.call(null,vec__23134,(0),null);
var protocol = cljs.core.nth.call(null,vec__23134,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23137){
var vec__23138 = p__23137;
var ns = cljs.core.nth.call(null,vec__23138,(0),null);
var name = cljs.core.nth.call(null,vec__23138,(1),null);
var selector = cljs.core.nth.call(null,vec__23138,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__23143,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23143,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23141_SHARP_){
return (obj[cljs.core.first.call(null,p1__23141_SHARP_)]);
});})(name,sorted_matches,vec__23143,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
