...
var o23052 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23052["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23053 = temp__5455__auto____$1;
return (o23053["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22164__auto__ = f;
return (o__22164__auto__["toString"]).call(o__22164__auto__);
} else {
return "";
}
...
try{var o__22164__auto___23056 = t;
(o__22164__auto___23056["cljs$lang$ctorPrWriter"]).call(o__22164__auto___23056,t,writer);
}catch (e23055){var __23057 = e23055;
}
...
var char_code = (function (){var o__22164__auto__ = (new String(char$));
return (o__22164__auto__["charCodeAt"]).call(o__22164__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22164__auto__ = String;
return (o__22164__auto__["fromCharCode"]).call(o__22164__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23058 = num_code;
switch (G__23058) {
case (1):
return (185);
...
var o__22164__auto__ = String;
return (o__22164__auto__["fromCharCode"]).call(o__22164__auto__,superscript_code);
});
/**
...
}catch (e23060){var _e__22171__auto__ = e23060;
return false;
}})())){
...
var vec__23061 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23061,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23064 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23064["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23065 = temp__5455__auto____$1;
return (o23065["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23068){
var vec__23069 = p__23068;
var ns_detector = cljs.core.nth.call(null,vec__23069,(0),null);
...
var G__23075 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23076 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23075;
remaining_tokens = G__23076;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23066){
var G__23067 = cljs.core.first.call(null,seq23066);
var seq23066__$1 = cljs.core.next.call(null,seq23066);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23067,seq23066__$1);
});
...
var vec__23080 = cljs.core.split_with.call(null,(function (p1__23079_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23079_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23080,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23080,(1),null);
...
var vec__23083 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23083,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23083,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23086 = cljs.core.rest.call(null,remaining_tokens);
var G__23087 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23086;
name_tokens = G__23087;
continue;
} else {
...
var vec__23090 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23090,(0),null);
var arity = cljs.core.nth.call(null,vec__23090,(1),null);
var vec__23093 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23093,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23093,(1),null);
var vec__23096 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23096,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23096,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23096,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23096,(3),null);
...
var vec__23102 = result;
var munged_ns = cljs.core.nth.call(null,vec__23102,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23102,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23102,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23102,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23102,(4),null);
var arity = cljs.core.nth.call(null,vec__23102,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23106 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23106,(0),null);
var args = cljs.core.nth.call(null,vec__23106,(1),null);
var vec__23109 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23109,(0),null);
var name = cljs.core.nth.call(null,vec__23109,(1),null);
...
var G__23112 = (arity + (1));
var G__23113 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23114){
var vec__23115 = p__23114;
var arity = cljs.core.nth.call(null,vec__23115,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23115,(1),null);
...
return cljs.core.get.call(null,arities,p1__23118_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23119_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23122){
var vec__23123 = p__23122;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23123,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23120){
var G__23121 = cljs.core.first.call(null,seq23120);
var seq23120__$1 = cljs.core.next.call(null,seq23120);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23121,seq23120__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23131__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23131__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23131__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23131__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23132 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23132,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23132,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23132,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23132,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23132,(4),null);
var arity = cljs.core.nth.call(null,vec__23132,(5),null);
...
var o__22164__auto__ = f;
return (o__22164__auto__["getBasis"]).call(o__22164__auto__);
});
/**
...
}catch (e23136){var _e__22171__auto__ = e23136;
...
var G__23137 = (obj[cljs.core.first.call(null,path)]);
var G__23138 = cljs.core.rest.call(null,path);
obj = G__23137;
path = G__23138;
continue;
} else {
...
return (function (accum,p__23139){
var vec__23140 = p__23139;
var bit = cljs.core.nth.call(null,vec__23140,(0),null);
var protocol = cljs.core.nth.call(null,vec__23140,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23143){
var vec__23144 = p__23143;
var ns = cljs.core.nth.call(null,vec__23144,(0),null);
var name = cljs.core.nth.call(null,vec__23144,(1),null);
var selector = cljs.core.nth.call(null,vec__23144,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23149,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23149,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23149,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23147_SHARP_){
return (obj[cljs.core.first.call(null,p1__23147_SHARP_)]);
});})(name,sorted_matches,vec__23149,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
