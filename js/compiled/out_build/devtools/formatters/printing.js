...
var len__4531__auto___23183 = arguments.length;
var i__4532__auto___23184 = (0);
while(true){
if((i__4532__auto___23184 < len__4531__auto___23183)){
args__4534__auto__.push((arguments[i__4532__auto___23184]));

var G__23185 = (i__4532__auto___23184 + (1));
i__4532__auto___23184 = G__23185;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23180){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23181,G__23182,seq23180__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23186_SHARP_){
return !((cljs.core.meta.call(null,p1__23186_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23187__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23191){var _e__22171__auto__ = e23191;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e23193){var _e__22171__auto__ = e23193;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23195 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23196 = opts;
...
var markup_db = cljs.core.get.call(null,map__23196__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23195;
}});
...
;
var temp__5455__auto___23200 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23200)){
var managed_print_level_23201 = temp__5455__auto___23200;
var _STAR_print_level_STAR_23199_23202 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23201;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23199_23202,managed_print_level_23201,temp__5455__auto___23200,writer,opts,job_fn){
return (function (p1__23198_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23198_SHARP_,null);
});})(_STAR_print_level_STAR_23199_23202,managed_print_level_23201,temp__5455__auto___23200,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23199_23202;
}} else {
job_fn.call(null);
}
