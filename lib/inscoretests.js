...
//----------------------------------------------------------------------------
var TestGlue = /** @class */ (function (_super) {
    __extends(TestGlue, _super);
    function TestGlue() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TestGlue.prototype.accept = function (event) {
    ...
    TestGlue.prototype.dragEnter = function (event) {
        event.preventDefault();
        var div = event.currentTarget;
        div.setAttribute('savedborder', div.style.border);
        div.style.border = "1px solid grey";
    };
    TestGlue.prototype.dragLeave = function (event) {
        event.preventDefault();
        var div = event.currentTarget;
        div.style.border = div.getAttribute('savedborder');
    };
